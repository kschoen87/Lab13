...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\linewidth]{images/splunk-as-admin.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\linewidth]{images/splunk-index-w-sysmon.png}
